...
import com.cvshealth.eccm.maintanancepanelservices.service.IProgramProfileClientExceptionService;
...
public class ProgramProfileClientExceptionController {
  ...
  public ResponseEntity<ProgramProfileClientException> addProgramProfileClientException(
      @RequestBody ProgramProfileClientException programProfileClientException, UriComponentsBuilder builder) {
    HttpHeaders headers = new HttpHeaders();
    ProgramProfileClientException result = programProfileClientExceptionService
        .addProgramProfileClientException(programProfileClientException);
    // if (flag == false) {
    // return new ResponseEntity<Void>(headers, HttpStatus.CONFLICT);
    // }

    headers.setLocation(builder.path("/programprofileclientexception/{id}")
        .buildAndExpand(programProfileClientException.getId()).toUri());
  ...
  public ResponseEntity<List<ProgramProfileClientException>> getAllProgramProfileClientExceptions() {
    List<ProgramProfileClientException> list = programProfileClientExceptionService
        .getAllProgramProfileClientExceptions();
  ...
  public ResponseEntity<ProgramProfileClientException> getProgramProfileClientExceptionById(
      @PathVariable("id") Integer id) {
    ProgramProfileClientException programProfileClientException = programProfileClientExceptionService
        .getProgramProfileClientExceptionById(id);
  ...
  public ResponseEntity<ProgramProfileClientException> updateProgramProfileClientException(
      @RequestBody ProgramProfileClientException programProfileClientException) {
