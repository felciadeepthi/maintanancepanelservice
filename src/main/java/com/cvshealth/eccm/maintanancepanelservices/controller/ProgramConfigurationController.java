...
import com.cvshealth.eccm.maintanancepanelservices.service.IProgramConfigurationService;
...
public class ProgramConfigurationController {
  ...
  public ResponseEntity<ProgramConfiguration> addProgramConfiguration(
      @RequestBody ProgramConfiguration programConfiguration, UriComponentsBuilder builder) {
    ...
    headers
        .setLocation(builder.path("/programconfiguration/{id}").buildAndExpand(programConfiguration.getId()).toUri());
  ...
  public ResponseEntity<ProgramConfiguration> updateProgramConfiguration(
      @RequestBody ProgramConfiguration programConfiguration) {
