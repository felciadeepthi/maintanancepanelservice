...
import com.cvshealth.eccm.maintanancepanelservices.service.IProgramProfileService;
...
public class ProgramProfileController {
  ...
  public ResponseEntity<ProgramProfile> addProgramProfile(@RequestBody ProgramProfile programProfile,
